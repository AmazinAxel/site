...
// List of searchable common emojis
export const searchableChars = {
'¡': 'inverted exclamation mark',
'‰': 'per mille sign',
'·': 'middle dot',
'₴': 'hryvnia sign (Ukrainian currency)',
'≠': 'not equal to sign',
...
'ɪ': 'Latin small letter capital i',
...
'◀': 'black left-pointing triangle',
'●': 'black circle',
'◦': 'white outline bullet',
'◘': 'inverse bullet',
'⚓': 'anchor',
'⛨': 'black cross on shield',
'☺': 'white outline smiling happy face',
'☻': 'black filled smiling happy face',
'¦': 'broken bar',
'☹': 'white frowning sad face',
...
'🧪': 'test tube',
'⚗': 'alembic',
'⯪': 'left-pointing curved angle',
'⯫': 'right-pointing curved angle',
...
'ᛱ': 'runic cross symbol',
'ᛲ': 'runic naud symbol',
'ᛳ': 'runic bjork symbol',
'ᛴ': 'runic madr symbol',
'ᛵ': 'runic yr symbol',
'ᛶ': 'runic kaun symbol',
'ᛷ': 'runic ior symbol',
